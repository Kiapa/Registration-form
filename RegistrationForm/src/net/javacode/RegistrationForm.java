...
public class RegistrationForm extends JFrame {
	...
	public RegistrationForm() {
			...
			public void actionPerformed(ActionEvent e) {
				 try {
					 Class.forName("com.mysql.cj.jdbc.Driver");
	                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Registration", "root", "Romeo14365_");
		...
		JLabel lblNewJgoodiesTitle = DefaultComponentFactory.getInstance().createTitle("Register Form");
		lblNewJgoodiesTitle.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblNewJgoodiesTitle.setBounds(39, 11, 160, 32);
